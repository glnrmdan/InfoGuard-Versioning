...
#                 user_email = latest_msg.from_  # Get the sender's email
#                 logging.debug(f"Email from: {user_email}")
...
#     return None, None, None  # Return three values, including None for user_email if no valid email is found
